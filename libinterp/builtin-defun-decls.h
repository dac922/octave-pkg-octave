...
DEFUN_DECL (Fenable_jit_debugging);
DEFUN_DECL (Fenable_jit_compiler);
DEFUN_DECL (Fall);
DEFUN_DECL (Fany);
DEFUN_DECL (Fatan2);
DEFUN_DECL (Fhypot);
...
DEFUN_DECL (Fread_readline_init_file);
DEFUN_DECL (Fre_read_readline_init_file);
...
DEFUN_DECL (Fdefault_save_options);
